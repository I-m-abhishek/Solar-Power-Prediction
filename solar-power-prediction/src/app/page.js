...
function Page() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://spp-backend.onrender.com/predict', {
        method: 'POST',
        headers: {
    ...
    <>
      ...
      >
        ...
        <div  className="flex-col sm:flex sm:flex-row sm:p-10 sm:pt-1 sm:pb-2">
          <div data-aos="fade-up" className="backdrop-blur-md border-2 border-[rgba(255,255,255,0.2)] bg-[#e1cd64] p-1 sm:p-3  m-1 md:p-5 rounded-md">
          ...
          <div data-aos="fade-up" className="backdrop-blur-md border-2 border-[rgba(255,255,255,0.2)] bg-white/60 p-1 sm:p-3 md:p-5 m-1 rounded-md">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="mt-2">
            <input  required value={formData.temperature_2_m_above_gnd} onChange={handleChange} type="number" name="temperature_2_m_above_gnd" id="temperature_2_m_above_gnd" className="w-full  p-1  rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder ="in °C (eg: 20) "/>
          </div> 
        </div>
        <div className="">
        ...
        <div className="">
          ...
          <div className="mt-2">
            <input required value={formData.mean_sea_level_pressure_MSL} onChange={handleChange} type="number" name="mean_sea_level_pressure_MSL" id="mean_sea_level_pressure_MSL" className="w-full   p-1 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in hPa or mb (eg: 1015)'/>
          </div> 
        </div>
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="mt-2">
            <input required  value={formData.total_precipitation_sfc} onChange={handleChange} type="number" name="total_precipitation_sfc" id="total_precipitation_sfc" className="w-full   p-1 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in mm (eg: 0)'/>
          </div> 
        </div>
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="mt-2">
            <input required value={formData.snowfall_amount_sfc} onChange={handleChange} type="number" name="snowfall_amount_sfc" id="snowfall_amount_sfc" className="w-full rounded-md border-0 py-1.5 p-1  text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in cm (eg: 0)'/>
          </div> 
        </div>
        <div className="">
          ...
          <div className="mt-2">
            <input required value={formData.total_cloud_cover_sfc} onChange={handleChange} type="number" name="total_cloud_cover_sfc" id="total_cloud_cover_sfc" className="w-full rounded-md border-0 py-1.5  p-1  text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 " placeholder='in percentage (eg: 10)' />
          </div> 
        </div>
        <div className="">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="mt-2">
            <input required value={formData.low_cloud_cover_low_cld_lay} onChange={handleChange} type="number" name="low_cloud_cover_low_cld_lay" id="low_cloud_cover_low_cld_lay" className="w-full  p-1  rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 " placeholder='in percentage (eg: 10)'/>
          </div> 
        </div>
        <div className="">
          ...
          <div className="mt-2">
            <input required value={formData.shortwave_radiation_backwards_sfc} onChange={handleChange} type="number" name="shortwave_radiation_backwards_sfc" id="shortwave_radiation_backwards_sfc" className="w-full rounded-md border-0 py-1.5 text-gray-900  p-1 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in W/m² (eg: 400)'/>
          </div> 
        </div>
        <div className="">
          ...
          <div className="mt-2">
            <input required value={formData.titleimgurl} onChange={handleChange} type="number" name="wind_speed_10_m_above_gnd" id="wind_speed_10_m_above_gnd" className="w-full rounded-md border-0  p-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in m/s (eg: 10)'/>
          </div> 
        </div>
        <div className="col-span-1 md:col-span-2">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="mt-2">
            <input required value={formData.titleimgurl} onChange={handleChange} type="number" name="wind_speed_80_m_above_gnd" id="wind_speed_80_m_above_gnd" className="w-full rounded-md border-0  p-1  py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in m/s (eg: 10)'/>
          </div> 
        </div>
        <div className="">
          ...
          <div className="mt-2">
            <input required value={formData.wind_direction_80_m_above_gnd} onChange={handleChange} type="number" name="wind_direction_80_m_above_gnd" id="wind_direction_80_m_above_gnd" className="w-full rounded-md border-0 py-1.5 text-gray-900  p-1  shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 " placeholder='in Degrees (eg: 100)' />
          </div> 
        </div>
        <div className="">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="mt-2">
            <input required value={formData.wind_direction_900_mb} onChange={handleChange} type="number" name="wind_direction_900_mb" id="wind_direction_900_mb" className="w-full rounded-md border-0 py-1.5  p-1  text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 " placeholder='in Degrees (eg: 100)' />
          </div> 
        </div>
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="mt-2">
            <input required value={formData.wind_gust_10_m_above_gnd} onChange={handleChange} type="number" name="wind_gust_10_m_above_gnd" id="wind_gust_10_m_above_gnd" className="  p-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in m/s (eg: 15)'/>
          </div> 
        </div>
        <div className="">
          <label htmlFor="angle_of_incidence" className=" text-sm font-medium leading-6 text-white">Angle of incidence</label>
          <div className="mt-2">
            <input required value={formData.angle_of_incidence} onChange={handleChange} type="number" name="angle_of_incidence" id="angle_of_incidence" className="w-full rounded-md border-0 py-1.5  p-1  text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in Degrees (eg: 100)'/>
          </div> 
        </div>
        <div className="">
          <label htmlFor="zenith" className=" text-sm font-medium leading-6 text-white">Solar zenith angle</label>
          <div className="mt-2">
            <input required value={formData.zenith} onChange={handleChange} type="number" name="zenith" id="zenith" className=" p-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in Degrees (eg: 100)'/>
          </div> 
        </div>
        <div className="col-span-1 md:col-span-2">
          <label htmlFor="azimuth" className=" text-sm font-medium leading-6 text-white">Solar azimuth angle</label>
          <div className="mt-2">
            <input required value={formData.azimuth} onChange={handleChange} type="number" name="azimuth" id="azimuth" className="p-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6  " placeholder='in Degrees (eg: 100)'/>
          </div> 
        </div>
