...
const Footer = () => {
    ...
    // if we are not putting email , then also it is working , it means validation is not working 
    // I have to work for validation 
    //  this is happening due to e.preventDefault() bcz it revoke the origninal validation
    // I need to make custom validation 
    ...
    return (
        <>
            <div className="p-2 sm:p-10 sm:pt-1 sm:pb-4 bg-[#111827] bg-opacity-100">
                <div></div>
                ...
                <div className="md:flex md:justify-between md:items-center pt-3">
                    <div className="flex order-2">
                        <Link className="p-1 ml-1 mr-1 text-[#b3bfd5] hover:text-[#eeeff1]" href="https://google.com">
                            <span className="h-0.5 w-0.5 overflow-hidden absolute ">
                                Facebook
                            </span>
                            <svg
                                fill="currentColor"
